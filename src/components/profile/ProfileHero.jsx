...
const ProfileHero = ({ user }) => {
  return (
    <div className="h-[300px] text-primary-dark-gray">
      <div className="h-[200px] bg-[url('/src/assets/images/green_bg.jpeg')]"></div>
      <div className="relative px-10 lg:px-20">
        <div className="absolute -top-10 h-[150px] rounded-xl w-[90%] bg-white p-4">
          <div className="relative flex justify-center items-center">
            <div className="absolute border-white border-[5px] -top-12 left-10 w-[140px] h-[136px] overflow-hidden rounded-lg">
            ...
            <div className="flex justify-between items-center gap-24">
              <div>
                <h1 className="font-bold text-5xl mb-5">{user.name}</h1>
