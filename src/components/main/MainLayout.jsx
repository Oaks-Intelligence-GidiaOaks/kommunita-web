    ...
    <>
      ...
      <section className="bg-[#EFF2FC]">
        ...
        <div className="mx-auto px-4 sm:px-4 lg:px-12 grid grid-cols-12 justify-between w-full">
          <div className="hidden md:block col-span-4 lg:col-span-3 xl:col-span-2">
            <SideNav />
          ...
          <div
            className={
              showNav
                ...
                : "col-span-12 md:col-span-8  lg:col-span-9 xl:col-span-10"
            }
          >
          ...
          {showNav && (
            <section className="hidden lg:block w-full col-span-3">
              <AdsSection />
            </section>
          )}
        </div>
